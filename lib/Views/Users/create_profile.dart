...
import 'createProfileService.dart';
...
class _CreateProfileDialogState extends State<CreateProfileDialog> {
  ...
  // Charger les données de la session (email et userId)
  Future<void> _loadSessionData() async {
    ...
    print("11111111111111111111111111111111111111122222222222222222222222222222222222222222");
    print(user?.email);
    _email = user?.email;

    _userId = user?.id;
    print("22222222222222222222222222222222222222222222222222222222222222222");
    setState(() {}); // Met à jour l'interface après avoir récupéré les données.
  }

  // Méthode de sélection de l'image
  Future<void> _pickImage() async {
    setState(() {
      _selectedImagePath = 'assets/user.jpg'; // À remplacer par un vrai picker si nécessaire
    });
  }
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(15),
                  border: Border.all(
                    color: const Color(0xFF29E33C).withOpacity(0.4),
                    width: 1,
                  ),
                ),
                child: ListTile(
                  ...
                  onTap: () {
                    setState(() => _selectedPack = pack);
                    // Passer à l'écran de paiement après la sélection du pack
                    CreateProfileService.openPaymentProfile(
                      context,
                      pack.id,
